...
<ul class="nav justify-content-center input-group-text">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo $url_produto."form_produto.php"; ?>">Cadastrar Produto</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="<?php echo $url_produto."lista_produto.php"; ?>">Listar Produto</a>
    </li>
    <li class="nav-item">
