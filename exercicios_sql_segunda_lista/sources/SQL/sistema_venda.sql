...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Fev-2023 às 02:00
...
(1, 1, '666666666', '9669696696', '2080-04-01'),
(2, 3, '321321', '123123', '1828-02-29'),
(3, 4, '654654', '456456', '1512-11-18'),
(4, 5, '05002023020', '80028922', '2001-05-31');
...
(1, 2, '1111111111', 'junin automecanica', 'felicidade');
...
(1, 'marcos', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3');
...
--
ALTER TABLE `pessoa_fisica`
  MODIFY `idpessoa_fisica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
